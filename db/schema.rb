...
ActiveRecord::Schema.define(version: 2019_08_22_111456) do
  ...
  create_table "problems", force: :cascade do |t|
    ...
    t.string "input_format", default: [], array: true
    t.string "output_format", default: [], array: true
  end

  create_table "sample_test_cases", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
